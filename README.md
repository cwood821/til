...
- [Make an array of files from glob pattern](notes/bash/make-array-files-pattern.md)
- [Mark variables as readonly](notes/bash/mark-variables-as-readonly.md)
- [Use arrays in Bash](notes/bash/use-arrays.md)

#### CSS
- [Add unit at end of `calc` expression](notes/add-unit-end-calc.md)
- [Load animation css separately based on user preference](notes/css/load-animations-separate)
...
- [Make new branch from stash](notes/git/make-new-branch-stash.md)
...
#### Mac OS
- [List available devices and runtimes in the Simulator App](notes/macos/show-available-devices-simulator.md)
...
- [Show currently running operations](notes/mysql/show-running-operations.md)
...
- [See memory usage with `free`](notes/unix/see-memory-usage-with-free.md)
